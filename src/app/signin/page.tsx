      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center">
            <p className="text-xs text-slate-400 mb-3">Don't want to create an account?</p>
            <Link href="/dashboard" className="text-sm font-black text-blue-600 hover:text-blue-700 transition-colors">
              Continue as Guest →
            </Link>
          </div>
        </div>
