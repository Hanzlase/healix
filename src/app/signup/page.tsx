      ...
      <div className="hidden md:flex md:w-1/2 bg-surface-900 text-white flex-col justify-between p-12 relative border-r border-surface-800">
        ...
        <div className="relative z-10 max-w-md">
          <h2 className="text-3xl font-extrabold tracking-tight mb-4 leading-tight">
            Automate diagnostics. Restore workflows.
          </h2>
          <p className="text-surface-400 text-sm leading-relaxed mb-6">
            Create an account to monitor your repository workflows, review surgical code patches, and streamline your deployments.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-sm flex flex-col gap-6">
          <div className="text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <h1 className="text-2xl font-extrabold text-surface-900 tracking-tight">Create Account</h1>
            <p className="text-sm text-surface-500 mt-1.5 font-medium">Get started with self-healing pipelines</p>
          </div>
          ...
          <div className="text-center text-xs font-semibold">
            <p className="text-surface-450">
              ...
              <Link href="/signin" className="text-brand-600 hover:text-brand-700 transition-colors underline underline-offset-4">
                Sign In
              </Link>
            </p>
          </div>
